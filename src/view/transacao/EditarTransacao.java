 ...
 * @author Rodrigo
 */
public class EditarTransacao extends javax.swing.JInternalFrame {
    ...
    public EditarTransacao(int id) throws Exception {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(barraValor, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            transacao = transacaoController.buscarTransacao(id, MeuEscritorio.usuarioLogado.email);
            ...
            transacaoController.atualizaTransacao(transacao);
            JOptionPane.showMessageDialog(null, "Transação atualizada com sucesso");
            Transacoes transacoes = new Transacoes();
            MeuEscritorio.jDesktopPane1.add(transacoes);
            transacoes.setMaximum(true);
            transacoes.setVisible(true);
            this.dispose();
    ...
    public void setSelectedRadio(ButtonGroup group, String texto) {
        for (Enumeration eRadio = group.getElements(); eRadio.hasMoreElements();) {
            JRadioButton radioButton = (JRadioButton) eRadio.nextElement();
    ...
    public void preencheJanela() throws Exception {
        TransacaoController transacaoController = new TransacaoController();
        transacao = transacaoController.buscarTransacao(this.id, MeuEscritorio.usuarioLogado.email);
        barraValor.setText("" + transacao.valor);
        jTextAreaDescricao.setText(transacao.descricao);
        setSelectedRadio(buttonGroup1, transacao.tipoTransacao);
        setSelectedRadio(buttonGroup2, transacao.tipoRecorrencia);
